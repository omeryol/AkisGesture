...
fun FeedbackAnimation.localizedLabel(context: Context): String = context.getString(when (this) {
    FeedbackAnimation.OCEAN_WAVE -> R.string.animation_ocean; FeedbackAnimation.MERCURY_TEARDROP -> R.string.animation_droplet; FeedbackAnimation.PLASMA_FIRE -> R.string.animation_fire; FeedbackAnimation.ATMOSPHERIC_MIST -> R.string.animation_mist; FeedbackAnimation.SOLAR_CORONA -> R.string.animation_sun; FeedbackAnimation.AURORA_RIBBON -> R.string.animation_aurora; FeedbackAnimation.GLASS_RIPPLE -> R.string.animation_glass; FeedbackAnimation.STARFIELD -> R.string.animation_stars; FeedbackAnimation.VORTEX -> R.string.animation_vortex; FeedbackAnimation.PRISM_FLOW -> R.string.animation_rain; FeedbackAnimation.COMET_TAIL -> R.string.animation_wind; FeedbackAnimation.QUANTUM_RING -> R.string.animation_bubbles; FeedbackAnimation.INK_FLOW -> R.string.animation_ink; FeedbackAnimation.BLACK_HOLE_PULL -> R.string.animation_night; FeedbackAnimation.HYDRO_WIPE -> R.string.animation_pressure; FeedbackAnimation.NONE -> R.string.animation_off
})
